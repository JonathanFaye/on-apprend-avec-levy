...
window.LEVELS.push({
  ...
  nameHe: "אֲנִי קוֹרֵא מִשְׁפָּטִים",
  emoji: "📖",
  color: "#6A1B9A",
  tagline: "Je lis des phrases entières !",
  taglineHe: "אֲנִי קוֹרֵא מִשְׁפָּטִים שְׁלֵמִים!",
  sublevels: [
    {
      id: "n6-s1",
      name: "Les minuscules",
      nameHe: "הָאוֹתִיּוֹת הַקְּטַנּוֹת",
      emoji: "🔡",
      lesson: {
        cards: [
          {
            title: "Les lettres se déguisent ! 🎭",
            titleHe: "הָאוֹתִיּוֹת מִתְחַפְּשׂוֹת!",
            body: "Chaque grande lettre a une petite sœur : A devient a, B devient b, C devient c. On les appelle les minuscules !",
            bodyHe: "לְכָל אוֹת גְּדוֹלָה יֵשׁ אָחוֹת קְטַנָּה: A הוֹפֶכֶת לְ-a, B הוֹפֶכֶת לְ-b, C הוֹפֶכֶת לְ-c. קוֹרְאִים לָהֶן אוֹתִיּוֹת קְטַנּוֹת!",
            big: "A a  B b  C c",
            say: "a. bé. cé."
          },
          {
            title: "C'est le même mot ! 👯",
            titleHe: "זוֹ אוֹתָהּ מִלָּה!",
            ...
            bodyHe: "CHAT וּ-chat זוֹ בְּדִיּוּק אוֹתָהּ מִלָּה! בַּסְּפָרִים כִּמְעַט הַכֹּל כָּתוּב בְּאוֹתִיּוֹת קְטַנּוֹת, עִם אוֹת גְּדוֹלָה בִּתְחִלַּת הַמִּשְׁפָּט.",
            big: "CHAT = chat",
            say: "chat."
          },
          {
            title: "Attention aux jumelles ! 👀",
            titleHe: "זְהִירוּת, תְּאוֹמוֹת!",
            body: "Certaines minuscules se ressemblent beaucoup : b et d, p et q. Regarde bien de quel côté est le ventre de la lettre !",
            bodyHe: "יֵשׁ אוֹתִיּוֹת קְטַנּוֹת שֶׁדּוֹמוֹת מְאוֹד: b וְ-d, p וְ-q. הִסְתַּכְּלוּ טוֹב בְּאֵיזֶה צַד נִמְצֵאת הַבֶּטֶן שֶׁל הָאוֹת!",
            big: "b d  p q",
            say: "bé. dé. pé. ku."
          }
        ]
      ...
      exercises: [
        {
          ...
          promptHe: "חַבְּרוּ כָּל אוֹת גְּדוֹלָה לָאָחוֹת הַקְּטַנָּה שֶׁלָּהּ!",
        ...
        },
        {
          ...
          promptHe: "מַהִי הָאוֹת הַקְּטַנָּה שֶׁל M?",
          question: "M",
          choices: ["m", "n", "w"],
          answer: 0,
          say: "aime",
          explain: "M devient m : deux petits ponts, comme la grande !",
          explainHe: "M הוֹפֶכֶת לְ-m: שְׁנֵי גְּשָׁרִים קְטַנִּים, כְּמוֹ הַגְּדוֹלָה!"
        },
        {
          type: "pick",
          prompt: "Quelle est la minuscule de B ?",
          promptHe: "מַהִי הָאוֹת הַקְּטַנָּה שֶׁל B?",
          question: "B",
          choices: ["d", "p", "b"],
          answer: 2,
          say: "bé",
          explain: "B devient b : un grand dos et un ventre en avant !",
          explainHe: "B הוֹפֶכֶת לְ-b: גַּב גָּבוֹהַּ וּבֶטֶן קָדִימָה!"
        },
        {
          type: "match",
          prompt: "Relie les grandes lettres aux petites !",
          promptHe: "חַבְּרוּ אֶת הָאוֹתִיּוֹת הַגְּדוֹלוֹת לַקְּטַנּוֹת!",
        ...
        },
        {
          ...
          explainHe: "chat נִכְתֶּבֶת c-h-a-t. גַּם בְּאוֹתִיּוֹת קְטַנּוֹת אַתֶּם יוֹדְעִים לִקְרֹא אוֹתָהּ!"
        },
        {
          type: "pick",
          prompt: "Trouve le mot MAISON écrit en minuscules !",
          promptHe: "מִצְאוּ אֶת הַמִּלָּה MAISON כְּתוּבָה בְּאוֹתִיּוֹת קְטַנּוֹת!",
          question: "MAISON",
          choices: ["raison", "saison", "maison"],
          answer: 2,
          say: "maison",
          explain: "maison : m-a-i-s-o-n, les mêmes lettres en petit ! 🏠",
          explainHe: "maison: בְּדִיּוּק אוֹתָן אוֹתִיּוֹת, רַק קְטַנּוֹת! 🏠"
        },
        {
          type: "listen",
          ...
          explainHe: "שְׁמַעְתֶּם bonjour, כְּמוֹ כְּשֶׁלֵּוִי אוֹמֵר בֹּקֶר טוֹב!"
        },
        {
          type: "fill",
          ...
          explainHe: "vélo נִכְתֶּבֶת v-é-l-o. לֵוִי אוֹהֵב אֶת הָאוֹפַנַּיִם הַכְּחֻלִּים שֶׁלּוֹ! 🚲"
        },
        {
          type: "build",
          prompt: "Assemble le mot lapin !",
          promptHe: "הִרְכִּיבוּ אֶת הַמִּלָּה lapin!",
          tiles: ["pin", "la", "lo"],
          answer: ["la", "pin"],
          say: "lapin",
        ...
        },
        {
          ...
          promptHe: "קִרְאוּ בְּקוֹל רָם אֶת הַמִּלִּים בְּאוֹתִיּוֹת קְטַנּוֹת!",
          text: "chat\nmaison\nvélo",
          say: "chat. maison. vélo.",
          explain: "Bravo ! Tu lis les minuscules comme un grand !",
          explainHe: "כָּל הַכָּבוֹד! אַתֶּם קוֹרְאִים אוֹתִיּוֹת קְטַנּוֹת כְּמוֹ גְּדוֹלִים!"
        }
      ],
      joke: {
        q: "Charade ! Mon premier miaule 🐱. Mon second recouvre ton corps. Mon tout se porte sur la tête ! 🤔",
        a: "Un chapeau ! CHAT + PEAU = CHAPEAU ! 🎩😹",
        qHe: "חִידָה! הַחֵלֶק הָרִאשׁוֹן הוּא חַיָּה שֶׁעוֹשָׂה מְיָאוּ (CHAT) 🐱. הַחֵלֶק הַשֵּׁנִי מְכַסֶּה אֶת הַגּוּף (PEAU). וְהַכֹּל בְּיַחַד? מַשֶּׁהוּ שֶׁשָּׂמִים עַל הָרֹאשׁ!",
    ...
    },
    {
      ...
      nameHe: "הַצְּלִילִים gn, ph, qu",
      emoji: "🎵",
      lesson: {
        cards: [
          {
            title: "Le son gn ⛰️",
            titleHe: "הַצְּלִיל gn",
            body: "Les lettres g et n ensemble font le son 'gne', comme dans montagne, ligne et signe.",
            bodyHe: "הָאוֹתִיּוֹת g וְ-n בְּיַחַד עוֹשׂוֹת אֶת הַצְּלִיל 'נְיֶה', כְּמוֹ בַּמִּלִּים montagne, ligne וְ-signe.",
            big: "gn → montagne",
            say: "gne. montagne. ligne. signe."
          },
          {
            title: "Le son ph 📷",
            titleHe: "הַצְּלִיל ph",
            body: "Les lettres p et h ensemble font le son 'f', comme dans photo, téléphone et phoque !",
            bodyHe: "הָאוֹתִיּוֹת p וְ-h בְּיַחַד עוֹשׂוֹת אֶת הַצְּלִיל f, כְּמוֹ בַּמִּלִּים photo, téléphone וְ-phoque!",
            big: "ph → photo",
            say: "fe. photo. téléphone. phoque."
          },
          {
            title: "Le son qu 🎶",
            titleHe: "הַצְּלִיל qu",
            body: "Les lettres q et u ensemble font le son 'k', comme dans qui, quatre et musique. Le u ne se prononce pas !",
            bodyHe: "הָאוֹתִיּוֹת q וְ-u בְּיַחַד עוֹשׂוֹת אֶת הַצְּלִיל k, כְּמוֹ בַּמִּלִּים qui, quatre וְ-musique. אֶת הַ-u לֹא מְבַטְּאִים!",
            big: "qu → quatre",
      ...
      exercises: [
        {
          ...
          explainHe: "ph עוֹשֶׂה אֶת הַצְּלִיל f: אֶת photo מְבַטְּאִים 'פוֹטוֹ'! 📷"
        },
        {
          type: "listen",
          prompt: "Écoute et choisis ce que tu entends !",
          ...
          explainHe: "photo מַתְחִילָה בִּצְלִיל f שֶׁנִּכְתַּב ph! 📷"
        },
        {
          type: "fill",
          prompt: "Complète le mot !",
          ...
          explainHe: "montagne נִכְתֶּבֶת עִם gn: mon-ta-gne! ⛰️"
        },
        {
          type: "pick",
          prompt: "Quel mot a le son 'gne' ?",
          promptHe: "בְּאֵיזוֹ מִלָּה יֵשׁ אֶת הַצְּלִיל 'נְיֶה' (gn)?",
          choices: ["lune", "lame", "ligne"],
          answer: 2,
          say: "ligne",
          explain: "Dans ligne, on entend 'gne' à la fin : li-gne !",
          explainHe: "בַּמִּלָּה ligne שׁוֹמְעִים 'נְיֶה' בַּסּוֹף: li-gne!"
        },
        {
          type: "build",
          prompt: "Assemble le mot musique !",
          promptHe: "הִרְכִּיבוּ אֶת הַמִּלָּה musique!",
          tiles: ["si", "que", "mu", "co"],
          answer: ["mu", "si", "que"],
          say: "musique",
        ...
        },
        {
          ...
          explainHe: "quatre מַתְחִילָה בְּ-qu שֶׁעוֹשֶׂה אֶת הַצְּלִיל k!"
        },
        {
          type: "type",
          ...
          explainHe: "photo נִכְתֶּבֶת p-h-o-t-o: הַצְּלִיל f נִכְתָּב ph!"
        },
        {
          type: "match",
        ...
        },
        {
          ...
          explainHe: "musique נִכְתֶּבֶת עִם qu: mu-si-que! 🎵"
        },
        {
          type: "read",
          ...
          explainHe: "אֵיזֶה מִשְׁפָּט מַצְחִיק! כָּל הַכָּבוֹד, קְרָאתֶם ph וְגַם gn!"
        }
      ],
      joke: {
        ...
        qHe: "חִידָה! הַחֵלֶק הָרִאשׁוֹן הוּא הַהֶפֶךְ מִגָּבוֹהַּ (BAS). הַחֵלֶק הַשֵּׁנִי הוּא הַהֶפֶךְ מִמְּאֻחָר (TÔT). וְהַכֹּל בְּיַחַד? מַשֶּׁהוּ שֶׁצָּף עַל הַמַּיִם!",
    ...
    },
    {
      ...
      nameHe: "מִלִּים קְטַנּוֹת וּמִשְׁפָּטִים",
      emoji: "💬",
      lesson: {
        cards: [
          {
            title: "Les petits mots partout 🔎",
            titleHe: "מִלִּים קְטַנּוֹת בְּכָל מָקוֹם",
            body: "Ces petits mots sont dans toutes les phrases : il, elle, est, et, dans, avec, sur, sous, je, tu. Apprends-les par cœur !",
            bodyHe: "הַמִּלִּים הַקְּטַנּוֹת הָאֵלֶּה נִמְצָאוֹת בְּכָל הַמִּשְׁפָּטִים: il, elle, est, et, dans, avec, sur, sous, je, tu. לִמְדוּ אוֹתָן בְּעַל פֶּה!",
            big: "il  elle  est  et",
            say: "il. elle. est. et. dans. avec. sur. sous. je. tu."
          },
          {
            title: "La phrase ✏️",
            titleHe: "הַמִּשְׁפָּט",
            body: "Une phrase commence par une MAJUSCULE et finit par un point. Regarde : Levy va à la piscine.",
            bodyHe: "מִשְׁפָּט מַתְחִיל בְּאוֹת גְּדוֹלָה וּמִסְתַּיֵּם בִּנְקֻדָּה. הִסְתַּכְּלוּ: Levy va à la piscine.",
          ...
          },
          {
            ...
            bodyHe: "סִימַן שְׁאֵלָה ? מְשַׁמֵּשׁ לִשְׁאֹל שְׁאֵלָה. סִימַן קְרִיאָה ! מְשַׁמֵּשׁ לִצְעֹק אוֹ לְהִתְפַּלֵּא!",
            big: ". ? !",
      ...
      exercises: [
        {
          ...
          explainHe: "הֶחָתוּל נִמְצָא sur (עַל) הַשֻּׁלְחָן: הוּא לְמַעְלָה! 🐱"
        },
        {
          type: "build",
          prompt: "Assemble la phrase !",
          promptHe: "הִרְכִּיבוּ אֶת הַמִּשְׁפָּט!",
          tiles: ["va", "Levy", "à", "piscine.", "la"],
          answer: ["Levy", "va", "à", "la", "piscine."],
          say: "Levy va à la piscine.",
          explain: "La phrase commence par une majuscule : Levy va à la piscine. 🏊",
          explainHe: "הַמִּשְׁפָּט מַתְחִיל בְּאוֹת גְּדוֹלָה: Levy va à la piscine. 🏊"
        },
        {
          type: "pick",
          prompt: "Quel signe finit une question ?",
          promptHe: "אֵיזֶה סִימָן מְסַיֵּם שְׁאֵלָה?",
          choices: ["!", ".", "?"],
          answer: 2,
          explain: "Le point d'interrogation ? finit toutes les questions !",
          explainHe: "סִימַן הַשְּׁאֵלָה ? מְסַיֵּם כָּל שְׁאֵלָה!"
        },
        {
          type: "fill",
          prompt: "Complète le début de la phrase !",
          promptHe: "הִשְׁלִימוּ אֶת תְּחִלַּת הַמִּשְׁפָּט!",
          sentence: "␣e chat dort.",
          choices: ["L", "l", "d"],
          answer: 0,
          say: "Le chat dort.",
          explain: "Une phrase commence toujours par une MAJUSCULE : Le chat dort.",
          explainHe: "מִשְׁפָּט תָּמִיד מַתְחִיל בְּאוֹת גְּדוֹלָה: Le chat dort."
        },
        {
          type: "pick",
          prompt: "Choisis la phrase bien écrite !",
          promptHe: "בַּחֲרוּ אֶת הַמִּשְׁפָּט הַכָּתוּב נָכוֹן!",
          ...
          explainHe: "אוֹת גְּדוֹלָה בַּהַתְחָלָה וְגַם נְקֻדָּה בַּסּוֹף: Le chat est sur la table."
        },
        {
          type: "pick",
          prompt: "Il ou elle ? Choisis pour la maîtresse !",
          promptHe: "il אוֹ elle? בַּחֲרוּ בִּשְׁבִיל הַמּוֹרָה!",
          question: "la maîtresse 👩‍🏫",
          choices: ["il", "elle"],
          answer: 1,
          say: "elle",
          explain: "La maîtresse est une femme, on dit ELLE. Pour Levy, on dit IL !",
          explainHe: "הַמּוֹרָה הִיא אִשָּׁה, אוֹמְרִים elle. עַל לֵוִי אוֹמְרִים il!"
        },
        {
          type: "listen",
          prompt: "Écoute et choisis la phrase que tu entends !",
          promptHe: "הַקְשִׁיבוּ וּבַחֲרוּ אֶת הַמִּשְׁפָּט שֶׁשְּׁמַעְתֶּם!",
          ...
          explainHe: "לֵוִי נִמְצָא avec (עִם) חָבֵר שֶׁלּוֹ: הֵם מְשַׂחֲקִים בְּיַחַד!"
        },
        {
          type: "fill",
          prompt: "Quelle ponctuation à la fin ?",
          promptHe: "אֵיזֶה סִימַן פִּסּוּק בַּסּוֹף?",
          ...
          explainHe: "זוֹ שְׁאֵלָה, אָז שָׂמִים סִימַן שְׁאֵלָה ?"
        },
        {
          type: "read",
          prompt: "Lis ces phrases à voix haute !",
          promptHe: "קִרְאוּ אֶת הַמִּשְׁפָּטִים בְּקוֹל רָם!",
          ...
          explainHe: "כָּל הַכָּבוֹד! עַכְשָׁו אַתֶּם קוֹרְאִים מִשְׁפָּטִים אֲמִתִּיִּים!"
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "avec נִכְתֶּבֶת a-v-e-c. לֵוִי מְשַׂחֵק עִם חָבֵר שֶׁלּוֹ!"
        }
      ],
      joke: {
        ...
        qHe: "חִידָה! הַחֵלֶק הָרִאשׁוֹן הוּא תָּו מוּזִיקָלִי (LA) 🎵. הַחֵלֶק הַשֵּׁנִי הוּא עֵץ יָרֹק (PIN) 🌲. וְהַכֹּל בְּיַחַד? חַיָּה עִם אָזְנַיִם גְּדוֹלוֹת!",
        ...
        cards: [
          {
            ...
            bodyHe: "כָּל הַכָּבוֹד! אַתֶּם יוֹדְעִים לִקְרֹא מִשְׁפָּטִים בְּאוֹתִיּוֹת קְטַנּוֹת, עִם gn, ph, qu וְסִימָנֵי פִּסּוּק. לֵוִי מַמָּשׁ גֵּאֶה בָּכֶם. עַכְשָׁו תּוֹרְכֶם!",
            big: "📖 ✨",
      ...
      exercises: [
        {
          ...
          promptHe: "חַבְּרוּ כָּל אוֹת גְּדוֹלָה לָאוֹת הַקְּטַנָּה שֶׁלָּהּ!",
        ...
        },
        {
          ...
          promptHe: "מִצְאוּ אֶת הַמִּלָּה MUSIQUE בְּאוֹתִיּוֹת קְטַנּוֹת!",
          question: "MUSIQUE",
        ...
        },
        {
          ...
          explainHe: "montagne מִסְתַּיֶּמֶת בִּצְלִיל 'נְיֶה': mon-ta-gne! ⛰️"
        },
        {
          type: "fill",
          prompt: "Complète le mot !",
          ...
          explainHe: "quatre נִכְתֶּבֶת עִם qu: q-u-a-t-r-e!"
        },
        {
          type: "build",
          prompt: "Assemble la phrase !",
          ...
          explainHe: "אוֹת גְּדוֹלָה בַּהַתְחָלָה וּנְקֻדָּה בַּסּוֹף: Le chat dort sous la table. 🐱"
        },
        {
          type: "pick",
          prompt: "Choisis la phrase bien écrite !",
          ...
          explainHe: "אוֹת גְּדוֹלָה בַּהַתְחָלָה וּנְקֻדָּה בַּסּוֹף: Elle joue avec le chat."
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "ligne נִכְתֶּבֶת l-i-g-n-e, עִם gn!"
        },
        {
          type: "pick",
          prompt: "Lis la phrase : où est Levy ?",
          promptHe: "קִרְאוּ אֶת הַמִּשְׁפָּט: אֵיפֹה לֵוִי?",
          ...
          explainHe: "הַמִּשְׁפָּט אוֹמֵר: לֵוִי נִמְצָא dans (בְּתוֹךְ) הַבְּרֵכָה! 🏊"
        },
        {
          type: "fill",
          prompt: "Quelle ponctuation à la fin ?",
          ...
          explainHe: "זוֹ שְׁאֵלָה: שָׂמִים סִימַן שְׁאֵלָה ?"
        },
        {
          type: "match",
          prompt: "Relie chaque mot à son image !",
        ...
        },
        {
          ...
          explainHe: "MOU (רַךְ, הַהֶפֶךְ מִקָּשֶׁה) + TON (שֶׁלְּךָ) = MOUTON, כֶּבֶשׂ! הַכֶּבֶשׂ עוֹשֶׂה מֶה! 🐑"
        }
      ],
      joke: {
        ...
        qHe: "חִידָה! הַחֵלֶק הָרִאשׁוֹן הוּא הַהֶפֶךְ מִ-sur (SOUS, מִתַּחַת). הַחֵלֶק הַשֵּׁנִי לָבָן וְאוֹכְלִים אוֹתוֹ (RIZ, אֹרֶז) 🍚. וְהַכֹּל בְּיַחַד? חַיָּה קְטַנָּה שֶׁאוֹהֶבֶת גְּבִינָה!",
        aHe: "עַכְבָּר! SOUS + RIZ = SOURIS! 🐭😂"
      }
    }
  ]
});
