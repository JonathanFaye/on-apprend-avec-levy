...
window.LEVELS.push({
  ...
  order: 10,
  name: "Super-champion",
  nameHe: "סוּפֶּר-אַלּוּף",
  emoji: "👑",
  color: "#B71C1C",
  tagline: "Je deviens un super-champion du français !",
  taglineHe: "אֲנִי הוֹפֵךְ לְסוּפֶּר-אַלּוּף בְּצָרְפָתִית!",
  sublevels: [
    {
      id: "n10-s1",
      name: "Le futur",
        ...
        cards: [
          {
            ...
            titleHe: "הֶעָתִיד הַקָּרוֹב",
            body: "Pour dire ce qui va bientôt arriver, on utilise aller + verbe : je vais jouer, tu vas manger, il va lire.",
            bodyHe: "כְּדֵי לְהַגִּיד מָה שֶׁיִּקְרֶה בְּקָרוֹב, מִשְׁתַּמְּשִׁים בְּ-aller + פֹּעַל: je vais jouer (אֲנִי הוֹלֵךְ לְשַׂחֵק), tu vas manger, il va lire.",
            big: "je vais jouer",
            say: "je vais jouer. tu vas manger. il va lire."
          },
          {
            title: "Le futur simple 🔮",
            titleHe: "הֶעָתִיד הַפָּשׁוּט",
            body: "Pour dire ce qui arrivera plus tard, le verbe se termine par -rai, -ras, -ra : je jouerai, tu joueras, il jouera.",
            bodyHe: "כְּדֵי לְהַגִּיד מָה שֶׁיִּקְרֶה מְאֻחָר יוֹתֵר, הַפּוֹעַל מִסְתַּיֵּם בְּ-rai, -ras, -ra: je jouerai (אֲנִי אֲשַׂחֵק), tu joueras, il jouera.",
            big: "je jouerai",
            say: "je jouerai. tu joueras. il jouera."
          },
          {
            title: "Deux façons de parler de demain 🌅",
            titleHe: "שְׁתֵּי דְּרָכִים לְדַבֵּר עַל מָחָר",
            body: "Demain, je vais jouer = futur proche. Demain, je jouerai = futur simple. Les deux parlent de demain !",
            bodyHe: "Demain, je vais jouer = עָתִיד קָרוֹב. Demain, je jouerai = עָתִיד פָּשׁוּט. שְׁנֵי הַמִּשְׁפָּטִים מְדַבְּרִים עַל מָחָר!",
            big: "demain",
      ...
      exercises: [
        {
          ...
          promptHe: "אֵיזֶה מִשְׁפָּט מְדַבֵּר עַל הֶעָתִיד?",
          ...
          explainHe: "«Je vais nager» = עָתִיד קָרוֹב: זֶה יִקְרֶה בְּקָרוֹב!"
        },
        {
          type: "pick",
          ...
          explainHe: "va + פֹּעַל = עָתִיד קָרוֹב. Il va lire: בְּקָרוֹב הוּא יִקְרָא!"
        },
        {
          type: "pick",
          prompt: "Trouve le verbe au futur simple !",
          promptHe: "מִצְאוּ אֶת הַפּוֹעַל בֶּעָתִיד הַפָּשׁוּט!",
          choices: ["je chante", "je vais chanter", "je chanterai"],
          answer: 2,
          say: "je chanterai",
          explain: "-rai à la fin = futur simple : je chanterai.",
          explainHe: "-rai בַּסּוֹף = עָתִיד פָּשׁוּט: je chanterai."
        },
        {
          type: "listen",
          prompt: "Écoute : présent ou futur ?",
          promptHe: "הַקְשִׁיבוּ: הוֹוֶה אוֹ עָתִיד?",
          say: "demain, nous irons à la piscine",
          choices: ["le présent", "le futur"],
          answer: 1,
          explain: "« Demain, nous irons » : c'est le futur !",
          explainHe: "«Demain, nous irons» (מָחָר נֵלֵךְ לַבְּרֵכָה): זֶה עָתִיד!"
        },
        {
          type: "match",
          prompt: "Relie chaque phrase à son temps !",
          promptHe: "חַבְּרוּ כָּל מִשְׁפָּט לַזְּמַן שֶׁלּוֹ!",
          ...
          explainHe: "vais + פֹּעַל = עָתִיד קָרוֹב, -rai = עָתִיד פָּשׁוּט, אַחֶרֶת זֶה הוֹוֶה."
        },
        {
          type: "pick",
          ...
          explainHe: "Jouerai = עָתִיד פָּשׁוּט, אָז זֶה יִקְרֶה מָחָר!"
        },
        {
          type: "pick",
          prompt: "Quelle phrase est au futur proche ?",
          promptHe: "אֵיזֶה מִשְׁפָּט הוּא בֶּעָתִיד קָרוֹב?",
          ...
          explainHe: "va faire = עָתִיד קָרוֹב. «Fera» זֶה עָתִיד פָּשׁוּט."
        },
        {
          type: "pick",
          prompt: "Quelle phrase est au futur simple ?",
          promptHe: "אֵיזֶה מִשְׁפָּט הוּא בֶּעָתִיד פָּשׁוּט?",
          ...
          explainHe: "chantera = עָתִיד פָּשׁוּט: -ra בְּסוֹף הַפֹּעַל."
        },
        {
          type: "read",
          prompt: "Lis ces phrases du futur à voix haute !",
          promptHe: "קִרְאוּ אֶת מִשְׁפְּטֵי הֶעָתִיד בְּקוֹל רָם!",
          ...
          explainHe: "כָּל הַכָּבוֹד! אַתֶּם קוֹרְאִים אֶת הֶעָתִיד כְּמוֹ אַלּוּפִים!"
        },
        {
          type: "pick",
          prompt: "Vrai ou faux ?",
          ...
          explainHe: "va pleuvoir = עָתִיד קָרוֹב: הַגֶּשֶׁם יַגִּיעַ בְּקָרוֹב!"
        }
      ],
      joke: {
        q: "Pourquoi les squelettes 💀 ne se battent-ils jamais entre eux ?",
        a: "Parce qu'ils n'ont pas les tripes ! 😂",
        qHe: "לָמָּה שְׁלָדִים 💀 אַף פַּעַם לֹא רָבִים זֶה עִם זֶה?",
        aHe: "כִּי אֵין לָהֶם tripes! (בְּצָרְפָתִית tripes זֶה גַּם 'מֵעַיִם' וְגַם 'אֹמֶץ' – וְלַשְּׁלָדִים אֵין מֵעַיִם!) 😂"
      }
    },
    {
      id: "n10-s2",
        ...
        cards: [
          {
            ...
            titleHe: "לְסַפֵּר מָה שֶׁכְּבָר קָרָה",
            body: "Pour raconter ce qui est déjà arrivé, on utilise avoir + verbe : j'ai mangé, tu as joué, il a fini. C'est le passé composé !",
            bodyHe: "כְּדֵי לְסַפֵּר מָה שֶׁכְּבָר קָרָה, מִשְׁתַּמְּשִׁים בְּ-avoir + פֹּעַל: j'ai mangé (אָכַלְתִּי), tu as joué, il a fini. זֶה נִקְרָא passé composé!",
            big: "j'ai mangé",
            say: "j'ai mangé. tu as joué. il a fini."
          },
          {
            title: "La terminaison -é ✏️",
            titleHe: "הַסִּיֹּמֶת é",
            body: "Avec les verbes en -er, on écrit -é à la fin : j'ai mangé, elle a dansé, nous avons joué.",
            bodyHe: "עִם פְּעָלִים שֶׁמִּסְתַּיְּמִים בְּ-er, כּוֹתְבִים é בַּסּוֹף: j'ai mangé, elle a dansé, nous avons joué.",
            big: "-é",
          ...
          },
          {
            ...
            bodyHe: "אֶתְמוֹל: j'ai joué (עָבָר). הַיּוֹם: je joue (הוֹוֶה). מָחָר: je jouerai (עָתִיד). אַתֶּם מַכִּירִים אֶת שְׁלֹשֶׁת הַזְּמַנִּים!",
      ...
      exercises: [
        {
          ...
          promptHe: "אֵיזֶה מִשְׁפָּט מְדַבֵּר עַל אֶתְמוֹל?",
          ...
          explainHe: "j'ai mangé = זְמַן עָבָר: זֶה כְּבָר קָרָה!"
        },
        {
          type: "pick",
          prompt: "C'est quel temps ?",
        ...
        },
        {
          ...
          promptHe: "הִשְׁלִימוּ בִּזְמַן עָבָר!",
          sentence: "Hier, Levy a mang␣ une pizza.",
          choices: ["er", "e", "é"],
          answer: 2,
          say: "hier, Levy a mangé une pizza",
          explain: "Après « a », le verbe en -er s'écrit avec -é : a mangé.",
          explainHe: "אַחֲרֵי «a», פֹּעַל שֶׁמִּסְתַּיֵּם בְּ-er נִכְתַּב עִם é: a mangé."
        },
        {
          type: "fill",
          prompt: "Choisis le bon mot !",
          promptHe: "בַּחֲרוּ אֶת הַמִּלָּה הַנְּכוֹנָה!",
        ...
        },
        {
          ...
          promptHe: "מִצְאוּ אֶת הַפּוֹעַל בִּזְמַן עָבָר!",
          ...
          explainHe: "avons chanté = זְמַן עָבָר: כְּבָר שַׁרְנוּ!"
        },
        {
          type: "listen",
          prompt: "Écoute : passé ou futur ?",
          promptHe: "הַקְשִׁיבוּ: עָבָר אוֹ עָתִיד?",
          say: "Levy a dessiné un chat",
          choices: ["le passé", "le futur"],
          answer: 0,
          explain: "a dessiné = passé composé : le dessin est déjà fait !",
          explainHe: "a dessiné = זְמַן עָבָר: הַצִּיּוּר כְּבָר מוּכָן!"
        },
        {
          type: "match",
          prompt: "Relie chaque moment à sa phrase !",
          promptHe: "חַבְּרוּ כָּל רֶגַע לַמִּשְׁפָּט שֶׁלּוֹ!",
        ...
        },
        {
          ...
          promptHe: "הִשְׁלִימוּ אֶת הַמִּשְׁפָּט!",
        ...
        },
        {
          ...
          promptHe: "סַדְּרוּ אֶת הַמִּשְׁפָּט לְפִי הַסֵּדֶר!",
          ...
          explainHe: "J'ai + mangé: זְמַן הֶעָבָר נִכְתַּב בִּשְׁתֵּי מִלִּים!"
        },
        {
          type: "pick",
          prompt: "Vrai ou faux ?",
          ...
          explainHe: "a dormi = זְמַן עָבָר: הֶחָתוּל כְּבָר יָשַׁן."
        }
      ],
      joke: {
        q: "Pourquoi les livres 📚 n'ont-ils jamais froid ? 🥶",
        a: "Parce qu'ils ont une couverture ! 😄",
        qHe: "לָמָּה לִסְפָרִים 📚 אַף פַּעַם לֹא קַר? 🥶",
        aHe: "כִּי יֵשׁ לָהֶם couverture! (בְּצָרְפָתִית זוֹ גַּם כְּרִיכָה שֶׁל סֵפֶר וְגַם שְׂמִיכָה – מִשְׂחַק מִלִּים!) 😄"
      }
    },
    {
      id: "n10-s3",
        ...
        cards: [
          {
            ...
            titleHe: "הַמִּלִּים הַגְּדוֹלוֹת",
            body: "Tu sais écrire de grands mots maintenant ! Découpe-les en syllabes : an-ni-ver-saire, mon-ta-gne, té-lé-phone.",
            bodyHe: "אַתֶּם כְּבָר יוֹדְעִים לִכְתֹּב מִלִּים גְּדוֹלוֹת! חַלְּקוּ אוֹתָן לַהֲבָרוֹת: an-ni-ver-saire, mon-ta-gne, té-lé-phone.",
            big: "anniversaire",
            say: "anniversaire. montagne. téléphone."
          },
          {
            title: "L'astuce de la dictée 💡",
            titleHe: "הַטְּרִיק שֶׁל הַהַכְתָּבָה",
            body: "Écoute le mot, découpe-le en syllabes dans ta tête, puis écris syllabe par syllabe. Facile !",
            bodyHe: "הַקְשִׁיבוּ לַמִּלָּה, חַלְּקוּ אוֹתָהּ לַהֲבָרוֹת בָּרֹאשׁ, וְאָז כִּתְבוּ הֲבָרָה אַחֲרֵי הֲבָרָה. קַל!",
            say: "an. ni. ver. saire. anniversaire !"
          },
          {
            title: "Lire comme un détective 🕵️",
            titleHe: "לִקְרֹא כְּמוֹ בַּלָּשׁ",
            body: "Quand tu lis une histoire, cherche les indices : qui ? où ? pourquoi ? comment ? Les réponses se cachent dans le texte !",
            bodyHe: "כְּשֶׁקּוֹרְאִים סִפּוּר, מְחַפְּשִׂים רְמָזִים: מִי? אֵיפֹה? לָמָּה? אֵיךְ? הַתְּשׁוּבוֹת מִתְחַבְּאוֹת בַּטֵּקְסְט!",
            big: "🔍"
          }
        ]
      },
      exercises: [
        {
          ...
          promptHe: "הַקְשִׁיבוּ וְכִתְבוּ אֶת הַמִּלָּה הַגְּדוֹלָה!",
          say: "anniversaire",
          answer: "anniversaire",
          strict: false,
          explain: "an-ni-ver-saire : 4 syllabes, avec deux N !",
          explainHe: "an-ni-ver-saire: 4 הֲבָרוֹת, עִם שְׁתֵּי N!"
        },
        {
          type: "type",
          ...
          explainHe: "mon-ta-gne: הַצְּלִיל GN כְּמוֹ בַּמִּלָּה ligne!"
        },
        {
          type: "read",
          prompt: "Lis cette histoire à voix haute !",
          promptHe: "קִרְאוּ אֶת הַסִּפּוּר בְּקוֹל רָם!",
          ...
          explainHe: "אֵיזוֹ מְסִבַּת יוֹם הֻלֶּדֶת יָפָה! קְרָאתֶם סִפּוּר גָּדוֹל!"
        },
        {
          type: "pick",
          prompt: "Pourquoi l'ami a-t-il caché les cadeaux ?",
          promptHe: "לָמָּה הֶחָבֵר הֶחְבִּיא אֶת הַמַּתָּנוֹת?",
          ...
          explainHe: "הַטֵּקְסְט אוֹמֵר: כְּדֵי לַעֲשׂוֹת הַפְתָּעָה לְ-Levy!"
        },
        {
          type: "pick",
          prompt: "Comment Levy montre-t-il sa joie ?",
          promptHe: "אֵיךְ Levy מַרְאֶה אֶת הַשִּׂמְחָה שֶׁלּוֹ?",
          ...
          explainHe: "Levy קוֹפֵץ מִשִּׂמְחָה: הוּא מְאוֹד שָׂמֵחַ!"
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "té-lé-phone: הַצְּלִיל F נִכְתַּב PH!"
        },
        {
          type: "read",
          prompt: "Lis cette histoire à voix haute !",
          ...
          explainHe: "כָּל הַכָּבוֹד! קְרָאתֶם סִפּוּר גָּדוֹל כְּמוֹ אַלּוּפִים!"
        },
        {
          type: "pick",
          prompt: "Pourquoi l'ami a-t-il marché doucement ?",
          promptHe: "לָמָּה הֶחָבֵר הָלַךְ לְאַט?",
          ...
          explainHe: "הַטֵּקְסְט אוֹמֵר: הוּא עָיֵף!"
        },
        {
          type: "pick",
          prompt: "Comment Levy a-t-il pris la photo ?",
          promptHe: "אֵיךְ Levy צִלֵּם אֶת הַתְּמוּנָה?",
          ...
          explainHe: "הַטֵּקְסְט אוֹמֵר: עִם הַטֵּלֵפוֹן שֶׁלּוֹ!"
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "cha-peau: הַצְּלִיל O בַּסּוֹף נִכְתַּב E-A-U!"
        }
      ],
      joke: {
        q: "Quelle est la lettre la plus coupante ✂️ de l'alphabet ?",
        a: "Le H, parce qu'il se prononce comme « hache » ! 🪓😆",
        qHe: "מַהִי הָאוֹת הֲכִי חַדָּה ✂️ בָּאָלֶף-בֵּית?",
        aHe: "הָאוֹת H! (בְּצָרְפָתִית קוֹרְאִים לָהּ 'ache', בְּדִיּוּק כְּמוֹ hache – גַּרְזֶן!) 🪓😆"
      }
    },
    {
      id: "n10-s4",
      name: "Le grand défi final",
      nameHe: "הָאֶתְגָּר הַגָּדוֹל הָאַחֲרוֹן",
      emoji: "🏆",
      lesson: {
        cards: [
          {
            title: "Le défi des super-champions ! 🏆",
            titleHe: "הָאֶתְגָּר שֶׁל הַסּוּפֶּר-אַלּוּפִים!",
            ...
            bodyHe: "הִגִּיעַ הָרֶגַע, אַלּוּף! הָאֶתְגָּר הָאַחֲרוֹן: אוֹתִיּוֹת, הֲבָרוֹת, צְלִילִים, מִלִּים, מִשְׁפָּטִים וּפְעָלִים... כָּל מָה שֶׁלְּמַדְתֶּם מֵהַהַתְחָלָה! Levy מַאֲמִין בָּכֶם. קָדִימָה!",
            big: "👑",
      ...
      exercises: [
        {
          ...
          promptHe: "אֵיזוֹ אוֹת בָּאָה מִיָּד אַחֲרֵי P?",
          choices: ["O", "Q", "R"],
          answer: 1,
          say: "pé",
          explain: "Dans l'alphabet : N, O, P, Q, R !",
          explainHe: "בָּאָלֶף-בֵּית: N, O, P, Q, R!"
        },
        {
          type: "listen",
          ...
          explainHe: "M + O = mo, כְּמוֹ בַּמִּלָּה moto!"
        },
        {
          type: "build",
          prompt: "Assemble le mot chocolat !",
          promptHe: "הִרְכִּיבוּ אֶת הַמִּלָּה chocolat!",
          tiles: ["co", "cho", "lat", "cha"],
          answer: ["cho", "co", "lat"],
          say: "chocolat",
          explain: "cho-co-lat : trois syllabes délicieuses !",
          explainHe: "cho-co-lat: שָׁלוֹשׁ הֲבָרוֹת טְעִימוֹת!"
        },
        {
          type: "pick",
          prompt: "Dans quel mot entends-tu le son ON ?",
          promptHe: "בְּאֵיזוֹ מִלָּה שׁוֹמְעִים אֶת הַצְּלִיל ON?",
          choices: ["mardi", "matin", "maison"],
          answer: 2,
          say: "maison. matin. mardi.",
          explain: "mai-son : on entend ON à la fin !",
          explainHe: "mai-son: שׁוֹמְעִים ON בַּסּוֹף!"
        },
        {
          type: "fill",
          prompt: "Complète le mot !",
          promptHe: "הִשְׁלִימוּ אֶת הַמִּלָּה!",
          sentence: "Levy boit un verre d'␣.",
          choices: ["o", "eau", "ho"],
          answer: 1,
          say: "un verre d'eau",
          explain: "Le son O de l'eau s'écrit E-A-U !",
          explainHe: "הַצְּלִיל O בַּמִּלָּה eau נִכְתַּב E-A-U!"
        },
        {
          type: "pick",
          prompt: "Quelle phrase est bien écrite ?",
          promptHe: "אֵיזֶה מִשְׁפָּט כָּתוּב נָכוֹן?",
          ...
          explainHe: "מִשְׁפָּט מַתְחִיל בְּאוֹת גְּדוֹלָה וּמִסְתַּיֵּם בִּנְקֻדָּה!"
        },
        {
          type: "type",
          prompt: "Dictée ! Écoute et écris le mot.",
          promptHe: "הַכְתָּבָה! הַקְשִׁיבוּ וְכִתְבוּ אֶת הַמִּלָּה.",
          say: "dimanche",
          answer: "dimanche",
          strict: false,
          explain: "di-manche : le son AN s'écrit A-N !",
          explainHe: "di-manche: הַצְּלִיל AN נִכְתַּב A-N!"
        },
        {
          type: "fill",
          prompt: "Complète la phrase !",
          ...
          explainHe: "שְׁנֵי חֲתוּלִים: בְּרַבִּים מוֹסִיפִים S!"
        },
        {
          type: "fill",
          prompt: "Choisis le bon mot !",
        ...
        },
        {
          ...
          promptHe: "חַבְּרוּ כָּל רֶגַע לַפּוֹעַל שֶׁלּוֹ!",
          pairs: [["hier", "j'ai chanté"], ["aujourd'hui", "je chante"], ["demain", "je chanterai"]],
          explain: "Passé, présent, futur : tu connais les trois temps !",
          explainHe: "עָבָר, הוֹוֶה, עָתִיד: אַתֶּם מַכִּירִים אֶת שְׁלֹשֶׁת הַזְּמַנִּים!"
        },
        {
          type: "riddle",
          ...
          explainHe: "CHAUD (חַם) + TÔT (מֻקְדָּם) = CHÂTEAU (טִירָה)! הַבַּיִת שֶׁל הַמֶּלֶךְ! 🏰"
        },
        {
          type: "read",
          prompt: "Lis le message de Levy à voix haute !",
          promptHe: "קִרְאוּ אֶת הַהוֹדָעָה שֶׁל Levy בְּקוֹל רָם!",
          ...
          explainHe: "עֲשִׂיתֶם אֶת זֶה! Levy כָּל כָּךְ גֵּאֶה בָּכֶם! 👑"
        }
      ],
      joke: {
        q: "Monsieur et Madame Térieur ont deux fils 👬. Comment s'appellent-ils ?",
        a: "Alain et Alex ! (Alain Térieur et Alex Térieur !) 🚪😂",
        qHe: "לָאָדוֹן וְלִגְבֶרֶת Térieur יֵשׁ שְׁנֵי בָּנִים 👬. אֵיךְ קוֹרְאִים לָהֶם?",
        aHe: "Alain וְ-Alex! (בְּצָרְפָתִית Alain Térieur נִשְׁמָע כְּמוֹ à l'intérieur – בִּפְנִים, וְ-Alex Térieur כְּמוֹ à l'extérieur – בַּחוּץ!) 🚪😂"
      }
    }
  ]
});
