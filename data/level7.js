...
window.LEVELS.push({
  ...
  taglineHe: "אֲנִי קוֹרֵא סִפּוּרִים שְׁלֵמִים!",
  sublevels: [
    {
      id: "n7-s1",
      name: "Levy à la piscine",
      nameHe: "Levy בַּבְּרֵכָה",
      emoji: "🏊",
      lesson: {
        cards: [
          {
            title: "On lit une vraie histoire ! 🌟",
            titleHe: "קוֹרְאִים סִפּוּר אֲמִתִּי!",
            ...
            bodyHe: "הַיּוֹם קוֹרְאִים סִפּוּר שָׁלֵם! קִרְאוּ לְאַט, מִשְׁפָּט אַחֲרֵי מִשְׁפָּט, מִשְּׂמֹאל לְיָמִין. אַחַר כָּךְ עוֹנִים עַל שְׁאֵלוֹת.",
            big: "📖"
          },
          {
            title: "Levy à la piscine 🏊",
            titleHe: "Levy בַּבְּרֵכָה",
            ...
            bodyHe: "Levy הוֹלֵךְ לַבְּרֵכָה עִם הֶחָבֵר שֶׁלּוֹ. חַם מְאוֹד. Levy קוֹפֵץ לַמַּיִם הַכְּחֻלִּים. הֶחָבֵר שֶׁלּוֹ שׂוֹחֶה עִם גַּלְגַּל יָם. אַחַר כָּךְ הֵם אוֹכְלִים גְּלִידָה.",
          ...
          },
          {
            ...
            bodyHe: "אַחֲרֵי הַסִּפּוּר Levy שׁוֹאֵל שְׁאֵלוֹת: מִי? אֵיפֹה? מָה? הַתְּשׁוּבָה תָּמִיד נִמְצֵאת בְּתוֹךְ הַסִּפּוּר!"
          }
        ]
      },
      exercises: [
        {
          ...
          explainHe: "כָּל הַכָּבוֹד! קְרָאתֶם סִפּוּר שָׁלֵם, כְּמוֹ גְּדוֹלִים!"
        },
        {
          type: "pick",
          prompt: "Qui va à la piscine avec Levy ?",
          promptHe: "מִי הוֹלֵךְ לַבְּרֵכָה עִם Levy?",
          say: "qui va à la piscine avec Levy ?",
          choices: ["la maîtresse", "son ami", "le chat"],
          answer: 1,
          explain: "C'est son ami qui va à la piscine avec Levy.",
          explainHe: "זֶה הֶחָבֵר שֶׁל Levy שֶׁהוֹלֵךְ אִתּוֹ לַבְּרֵכָה."
        },
        {
          type: "pick",
          prompt: "Où vont Levy et son ami ?",
          promptHe: "לְאָן הוֹלְכִים Levy וְהֶחָבֵר שֶׁלּוֹ?",
          ...
          explainHe: "הֵם הוֹלְכִים לַבְּרֵכָה, לִשְׂחוֹת וְלִקְפֹּץ לַמַּיִם!"
        },
        {
          type: "pick",
          ...
          explainHe: "בַּסִּפּוּר כָּתוּב: חַם מְאוֹד. בִּגְלַל זֶה הֵם הוֹלְכִים לִשְׂחוֹת!"
        },
        {
          type: "pick",
          prompt: "Que fait Levy à la piscine ?",
          promptHe: "מָה עוֹשֶׂה Levy בַּבְּרֵכָה?",
          ...
          explainHe: "Levy קוֹפֵץ לַמַּיִם הַכְּחֻלִּים. ספלאשׁ!"
        },
        {
          type: "fill",
          prompt: "Complète la phrase de l'histoire !",
          promptHe: "הַשְׁלִימוּ אֶת הַמִּשְׁפָּט מֵהַסִּפּוּר!",
          sentence: "Son ami nage avec une ␣.",
          choices: ["moto", "bouée", "table"],
          answer: 1,
          say: "bouée",
          explain: "Dans l'histoire, son ami nage avec une bouée.",
          explainHe: "בַּסִּפּוּר הֶחָבֵר שֶׁלּוֹ שׂוֹחֶה עִם גַּלְגַּל יָם."
        },
        {
          type: "pick",
          prompt: "Que mangent-ils après la piscine ?",
          promptHe: "מָה הֵם אוֹכְלִים אַחֲרֵי הַבְּרֵכָה?",
          ...
          explainHe: "אַחֲרֵי הַבְּרֵכָה הֵם אוֹכְלִים גְּלִידָה. טָעִים!"
        },
        {
          type: "build",
          prompt: "Remets les mots dans l'ordre !",
          promptHe: "סַדְּרוּ אֶת הַמִּלִּים בַּסֵּדֶר הַנָּכוֹן!",
          ...
          explainHe: "הַמִּשְׁפָּט מַתְחִיל בְּ-Levy עִם אוֹת גְּדוֹלָה וְנִגְמָר בִּנְקֻדָּה."
        },
        {
          type: "match",
          ...
          explainHe: "piscine = בְּרֵכָה, glace = גְּלִידָה, eau = מַיִם."
        },
        {
          type: "listen",
          ...
          explainHe: "שְׁמַעְתֶּם: piscine, עִם PI בַּהַתְחָלָה."
        }
      ],
      joke: {
        q: "Quel est le sport le plus fruité ? 🍑",
        a: "La boxe, parce qu'on se prend des pêches ! 🥊😂",
        qHe: "מַהוּ הַסְּפּוֹרְט הֲכִי פֵּרוֹתִי? 🍑",
        aHe: "הָאִגְרוּף! כִּי בְּצָרְפָתִית pêche זֶה גַּם אֲפַרְסֵק וְגַם מַכַּת אֶגְרוֹף! 🥊😂"
      }
    },
    {
      id: "n7-s2",
      name: "Le Shabbat chez Levy",
      nameHe: "שַׁבָּת אֵצֶל Levy",
      emoji: "🕯️",
      lesson: {
        cards: [
          {
            title: "Vendredi soir ✨",
            titleHe: "עֶרֶב שִׁשִּׁי",
            body: "Le vendredi soir, le Shabbat commence. On allume les bougies, on chante, et il y a deux pains dorés sur la table.",
            bodyHe: "בְּעֶרֶב שִׁשִּׁי מַתְחִילָה הַשַּׁבָּת. מַדְלִיקִים נֵרוֹת, שָׁרִים, וְיֵשׁ שְׁתֵּי חַלּוֹת זְהֻבּוֹת עַל הַשֻּׁלְחָן.",
            big: "🕯️🍞"
          },
          {
            title: "Le Shabbat chez Levy 🕯️",
            titleHe: "שַׁבָּת אֵצֶל Levy",
            ...
            bodyHe: "עֶרֶב שִׁשִּׁי. Levy מַדְלִיק אֶת הַנֵּרוֹת. עַל הַשֻּׁלְחָן יֵשׁ שְׁתֵּי חַלּוֹת זְהֻבּוֹת. Levy שָׁר שִׁיר יָפֶה. כָּל הַמִּשְׁפָּחָה אוֹמֶרֶת: שַׁבַּת שָׁלוֹם!",
          ...
          },
          {
            ...
            bodyHe: "Levy יַגִּיד לָכֶם מִשְׁפָּטִים. אִם הַמִּשְׁפָּט כְּמוֹ בַּסִּפּוּר — זֶה VRAI (נָכוֹן). אִם לֹא — זֶה FAUX (לֹא נָכוֹן)!"
          }
        ]
      },
      exercises: [
        {
          ...
          explainHe: "כָּל הַכָּבוֹד! אֵיזֶה סִפּוּר שַׁבָּת יָפֶה!"
        },
        {
          type: "pick",
          prompt: "Quel soir commence le Shabbat ?",
          promptHe: "בְּאֵיזֶה עֶרֶב מַתְחִילָה הַשַּׁבָּת?",
          ...
          explainHe: "הַשַּׁבָּת מַתְחִילָה בְּעֶרֶב שִׁשִּׁי, כְּשֶׁמַּדְלִיקִים אֶת הַנֵּרוֹת."
        },
        {
          type: "pick",
          prompt: "Qui allume les bougies ?",
          promptHe: "מִי מַדְלִיק אֶת הַנֵּרוֹת?",
          say: "qui allume les bougies ?",
          choices: ["la maîtresse", "le chat", "Levy"],
          answer: 2,
          explain: "C'est Levy qui allume les bougies de Shabbat.",
          explainHe: "Levy הוּא שֶׁמַּדְלִיק אֶת נֵרוֹת הַשַּׁבָּת."
        },
        {
          type: "pick",
          prompt: "Qu'y a-t-il sur la table ?",
          promptHe: "מָה יֵשׁ עַל הַשֻּׁלְחָן?",
          ...
          explainHe: "עַל הַשֻּׁלְחָן יֵשׁ שְׁתֵּי חַלּוֹת זְהֻבּוֹת לְשַׁבָּת."
        },
        {
          type: "pick",
          prompt: "Vrai ou faux ?",
          ...
          explainHe: "נָכוֹן! בַּסִּפּוּר Levy מַדְלִיק אֶת הַנֵּרוֹת."
        },
        {
          type: "pick",
          prompt: "Vrai ou faux ?",
          ...
          explainHe: "לֹא נָכוֹן! עַל הַשֻּׁלְחָן יֵשׁ שְׁתֵּי חַלּוֹת זְהֻבּוֹת, לֹא פִּיצָה."
        },
        {
          type: "pick",
          prompt: "Vrai ou faux ?",
          ...
          explainHe: "נָכוֹן! כָּל הַמִּשְׁפָּחָה אוֹמֶרֶת: שַׁבַּת שָׁלוֹם!"
        },
        {
          type: "fill",
          prompt: "Complète la phrase de l'histoire !",
          ...
          explainHe: "Levy מַדְלִיק אֶת נֵרוֹת הַשַּׁבָּת."
        },
        {
          type: "match",
          prompt: "Relie chaque mot à son image !",
          ...
          explainHe: "bougie = נֵר, pain = לֶחֶם, famille = מִשְׁפָּחָה."
        },
        {
          type: "listen",
          prompt: "Écoute et choisis ce que tu entends !",
          ...
          explainHe: "שְׁמַעְתֶּם: pain, עִם הַצְּלִיל P בַּהַתְחָלָה."
        }
      ],
      joke: {
        q: "Quel est le comble pour un boulanger ? 🥖",
        a: "C'est d'être dans le pétrin ! 😂",
        qHe: "מָה הֲכִי מַצְחִיק שֶׁיָּכוֹל לִקְרוֹת לְאוֹפֶה? 🥖",
        aHe: "לִהְיוֹת בְּתוֹךְ הַ-pétrin! בְּצָרְפָתִית pétrin זֶה גַּם הַכְּלִי שֶׁלָּשִׁים בּוֹ בָּצֵק וְגַם 'צָרָה גְּדוֹלָה'! 😂"
      }
    },
    {
      id: "n7-s3",
      name: "La dictée des champions",
      nameHe: "הַהַכְתָּבָה שֶׁל הָאַלּוּפִים",
      emoji: "✏️",
      lesson: {
        cards: [
          {
            ...
            bodyHe: "הַקְשִׁיבוּ טוֹב לַמִּלָּה, חִזְרוּ עָלֶיהָ בָּרֹאשׁ, וְאָז כִּתְבוּ אוֹתָהּ אוֹת אַחֲרֵי אוֹת. אֶפְשָׁר לְהַקְשִׁיב שׁוּב כַּמָּה שֶׁרוֹצִים!",
            big: "✏️"
          },
          {
            title: "Les mots de tous les jours 📝",
            titleHe: "מִלִּים שֶׁל כָּל יוֹם",
            body: "Voici des mots qu'on voit partout : maison, école, gâteau, bonjour. Regarde-les bien avant la dictée !",
            bodyHe: "הִנֵּה מִלִּים שֶׁרוֹאִים בְּכָל מָקוֹם: maison, école, gâteau, bonjour. הִסְתַּכְּלוּ עֲלֵיהֶן טוֹב לִפְנֵי הַהַכְתָּבָה!",
            big: "maison école gâteau bonjour",
            say: "maison. école. gâteau. bonjour."
          },
          {
            title: "La phrase en ordre 🧩",
            titleHe: "מִשְׁפָּט לְפִי הַסֵּדֶר",
            body: "Une phrase commence par une majuscule et finit par un point. Remets les mots dans le bon ordre, de gauche à droite !",
            bodyHe: "מִשְׁפָּט מַתְחִיל בְּאוֹת גְּדוֹלָה וְנִגְמָר בִּנְקֻדָּה. סַדְּרוּ אֶת הַמִּלִּים בַּסֵּדֶר הַנָּכוֹן, מִשְּׂמֹאל לְיָמִין!"
          }
        ]
      },
      exercises: [
        {
          ...
          promptHe: "הַקְשִׁיבוּ וְכִּתְבוּ אֶת הַמִּלָּה!",
          say: "maison",
          answer: "maison",
          strict: false,
          explain: "On écrit : maison. Le son AI est au milieu, et le son ON à la fin.",
          explainHe: "כּוֹתְבִים maison. הַצְּלִיל AI בָּאֶמְצַע, וְהַצְּלִיל ON בַּסּוֹף."
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "כּוֹתְבִים école, עִם é עִם אֶקְסְנֵט בַּהַתְחָלָה."
        },
        {
          type: "build",
          prompt: "Remets les mots dans l'ordre !",
          ...
          explainHe: "הַמִּשְׁפָּט הוּא: Levy mange un gâteau. מַתְחִילִים בְּ-Levy, עִם אוֹת גְּדוֹלָה."
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "כּוֹתְבִים bonjour: הַצְּלִיל ON וְאָז הַצְּלִיל OU."
        },
        {
          type: "build",
          prompt: "Remets les mots dans l'ordre !",
          ...
          explainHe: "הַמִּשְׁפָּט הוּא: Levy est dans la maison."
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
        ...
        },
        {
          ...
          explainHe: "הַמִּשְׁפָּט הוּא: Levy joue au ballon."
        },
        {
          type: "fill",
          ...
          explainHe: "זוֹ הַמִּלָּה école, עִם é עִם אֶקְסְנֵט בַּהַתְחָלָה."
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
        ...
        },
        {
          ...
          explainHe: "שְׁמַעְתֶּם: gâteau, עִם GA בַּהַתְחָלָה."
        }
      ],
      joke: {
        q: "Quel est le comble pour un électricien ? ⚡",
        a: "C'est de ne pas être au courant ! 💡😂",
        qHe: "מָה הֲכִי מַצְחִיק שֶׁיָּכוֹל לִקְרוֹת לַחַשְׁמַלַּאי? ⚡",
        aHe: "לֹא לִהְיוֹת au courant! בְּצָרְפָתִית courant זֶה גַּם זֶרֶם חַשְׁמַלִּי, וּ-être au courant זֶה 'לָדַעַת מָה קוֹרֶה'! 💡😂"
      }
    },
    {
      id: "n7-s4",
        ...
        cards: [
          {
            ...
            bodyHe: "הִנֵּה סִפּוּר Pokémon גָּדוֹל בִּשְׁנֵי חֲלָקִים! קִרְאוּ טוֹב, עֲנוּ עַל הַשְּׁאֵלוֹת וְהִפְכוּ לְאַלּוּפֵי קְרִיאָה!",
            big: "🏆"
          }
        ]
      },
      exercises: [
        {
          ...
          promptHe: "קִרְאוּ אֶת הַחֵלֶק הָרִאשׁוֹן שֶׁל הַסִּפּוּר!",
          ...
          explainHe: "כָּל הַכָּבוֹד! קְרָאתֶם אֶת הַחֵלֶק הָרִאשׁוֹן שֶׁל הַסִּפּוּר!"
        },
        {
          type: "pick",
          ...
          explainHe: "Levy מְשַׂחֵק בַּגִּנָּה כְּשֶׁהוּא מוֹצֵא אֶת הַ-Pokémon הַקָּטָן."
        },
        {
          type: "pick",
          prompt: "Pourquoi le Pokémon pleure-t-il ?",
          promptHe: "לָמָּה הַ-Pokémon בּוֹכֶה?",
          ...
          explainHe: "הַ-Pokémon בּוֹכֶה כִּי הוּא אִבֵּד אֶת הַמְּאַלֵּף שֶׁלּוֹ."
        },
        {
          type: "pick",
        ...
        },
        {
          ...
          explainHe: "הַ-Pokémon אָבוּד: הוּא לֹא מוֹצֵא אֶת הַמְּאַלֵּף שֶׁלּוֹ."
        },
        {
          type: "pick",
          prompt: "Vrai ou faux ?",
          ...
          explainHe: "נָכוֹן, הַ-Pokémon הַמִּסְכֵּן בּוֹכֶה כִּי הוּא אָבוּד."
        },
        {
          type: "read",
          prompt: "Lis la suite de l'histoire !",
          promptHe: "קִרְאוּ אֶת הֶמְשֵׁךְ הַסִּפּוּר!",
          ...
          explainHe: "כָּל הַכָּבוֹד! קְרָאתֶם אֶת כָּל הַסִּפּוּר עַל הַ-Pokémon הָאָבוּד!"
        },
        {
          type: "pick",
          prompt: "Qui arrive le soir ?",
          promptHe: "מִי מַגִּיעַ בָּעֶרֶב?",
          say: "qui arrive le soir ?",
          choices: ["la maîtresse", "le dresseur", "un ami"],
          answer: 1,
          explain: "Le soir, le dresseur du Pokémon arrive enfin.",
          explainHe: "בָּעֶרֶב סוֹף סוֹף מַגִּיעַ הַמְּאַלֵּף שֶׁל הַ-Pokémon."
        },
        {
          type: "build",
          prompt: "Remets les mots dans l'ordre !",
          ...
          explainHe: "הַמִּשְׁפָּט הוּא: Le Pokémon saute de joie."
        },
        {
          type: "match",
          prompt: "Relie chaque mot à son image !",
          ...
          explainHe: "jardin = גִּנָּה, gâteau = עוּגָה, soir = עֶרֶב, champion = אַלּוּף."
        },
        {
          type: "type",
          prompt: "Écoute et écris le mot !",
          ...
          explainHe: "כּוֹתְבִים merci: M-E-R-C-I, כְּמוֹ שֶׁהַמְּאַלֵּף אוֹמֵר לְ-Levy!"
        },
        {
          type: "pick",
          prompt: "Comment est le Pokémon à la fin ?",
          promptHe: "אֵיךְ מַרְגִּישׁ הַ-Pokémon בַּסּוֹף?",
          ...
          explainHe: "בַּסּוֹף הַ-Pokémon קוֹפֵץ מִשִּׂמְחָה: הוּא מְאוֹד שָׂמֵחַ!"
        }
      ],
      joke: {
        q: "Quel est le sport le plus silencieux ? 🤫",
        a: "Le parachutisme, parce qu'il faut dire CHUT ! 🪂😂",
        qHe: "מַהוּ הַסְּפּוֹרְט הֲכִי שָׁקֵט? 🤫",
        aHe: "הַצְּנִיחָה! כִּי בְּתוֹךְ הַמִּלָּה parachute מִתְחַבֵּאת הַמִּלָּה chut — 'שְׁשְׁשְׁשְׁ!' 🪂😂"
      }
    }
  ]
});
